  ...
  return (
    <div className="sobr-dark min-h-screen bg-sobr-root">
      <Seo
        ...
        description="How Sobr collects, uses, and protects your personal information."
        path="/privacy"
      />
      {/* Content */}
      <main className="container mx-auto px-4 py-12 md:py-20 max-w-3xl">
        ...
        <Section title="8. Artificial Intelligence (AI) and Machine Learning Features">
          ...
          <SubSection title='B. "Soby" Empathetic AI Chatbot, Voice Processing & Anonymized Behavioral Data'>
            <p>The App features an optional interactive AI chatbot named "Soby," powered by Hume AI (for emotional intelligence and conversational processing) and ElevenLabs (for voice synthesis).</p>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong className="text-sobr-text">Soby Interaction Data:</strong> If you interact with Soby via voice or text, your audio recordings and chat transcripts are securely transmitted to these providers via API strictly to generate Soby's real-time responses.</li>
              <li><strong className="text-sobr-text">Anonymized Behavioral Data:</strong> To improve the effectiveness of the App's AI features, BrightSlides LLC may transmit anonymized behavioral data to AI processing systems. This includes data such as drinking patterns, urge frequency, mood trends, streak history, and check-in responses. Before any such transmission, all personally identifiable information (PII) is removed — including name, email address, phone number, physical address, and any unique account or device identifiers. This anonymized data is not traceable to you individually.</li>
              <li><strong className="text-sobr-text">Important Limitation — No Guarantee Against AI Model Training:</strong> BrightSlides LLC cannot guarantee that third-party AI providers, including Hume AI and ElevenLabs, will not use transmitted data — including anonymized data — to improve, fine-tune, or train their AI models. While we employ enterprise-level API integrations that include contractual data-use restrictions, and implement zero-retention API settings where technically available, these measures are subject to the terms, policies, and technical capabilities of each provider and may change without notice. By enabling and using Soby, you acknowledge and accept this limitation.</li>
            </ul>
          </SubSection>
        </Section>
