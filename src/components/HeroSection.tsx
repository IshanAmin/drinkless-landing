          ...
          <div className="space-y-6">
            <h2 className="text-4xl md:text-6xl font-bold leading-tight md:leading-none text-white">
              ...
              <div className="relative">
                <span className="absolute text-black/20 -translate-x-[2px] -translate-y-[2px]">Leave Alcohol Behind</span>
                <span className="relative text-white">Leave Alcohol Behind</span>
              </div>
            </h2>
